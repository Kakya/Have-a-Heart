...
function update() {
	if(launched)
	{
		...
		function startGame()
		{
			...
			{
				text = game.add.text(game.world.centerX, game.world.centerY, "مرحبا! أنت فزت بأكبرجاءزة \nفي العالم! لقد تم تضمنك بفرقة 137أنا لا أقصد 731. على أي حال، ومن المعروف أن ال137القاتلة لشيء واحد وشيء واحد فقط: تقدم العلم! اسمع، أنا متأكد تحدثوا هذولة زملاء ال731 أيضا عن العلم، ولكني ما\n أعرفهم. على أي حال، وحان الوقت لنرى ما قمنا بإعداد لك", { font: "20px Times New Roman", fill: "#000", align: "center" });
			}
			text.anchor.setTo(0.5, 0.5);
			text.visible = true;
			game.input.onDown.addOnce(removeText, this);
